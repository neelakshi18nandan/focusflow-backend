...
public class Dto {
    ...
    // FIXED: Restored full 5-arg constructor + isSuccess() that
    // UserService/AuthController use
    ...
    public static class SessionRequest {
        ...
        public void setDurationSec(int d) {
            this.durationSec = d;
        }

        public int getPlannedSec() {
            return plannedSec;
        }

        public void setPlannedSec(int p) {
            this.plannedSec = p;
        }

        public int getTotalPlannedSec() {
            return totalPlannedSec;
        }

        public void setTotalPlannedSec(int t) {
            this.totalPlannedSec = t;
        }
    }
    ...
    public static class AnalyticsSummary {
        ...
        public List<StudyLogResponse> getLogs() {
            return logs;
        }
    }
}